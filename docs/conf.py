...
# -*- coding: utf-8 -*-
#
# Pangeo Catalog build configuration file, created by
...
project = 'Pangeo Catalog'
copyright = '2019, Ryan Abernathey'
...
htmlhelp_basename = 'SphinxPangeoCatalog'
...
latex_documents = [
    (master_doc, 'SphinxPangeoCatalog.tex', 'Pangeo Catalog',
...
man_pages = [
    (master_doc, 'sphinxpangeocatalog', 'Pangeo Catalog',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'SphinxPangeoCatalog', 'Sphinx Pangeo Catalog Documentation',
     author, 'SphinxPangeoCatalog', 'One line description of project.',
     'Miscellaneous'),
]
